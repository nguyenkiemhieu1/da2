...
public class Custom_Spiner_Chi extends BaseAdapter {
    ArrayList<KhoanChi> arChi;
    Context context;

    public Custom_Spiner_Chi(ArrayList<KhoanChi> arChi, Context context) {
        this.arChi = arChi;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        KhoanChi khoanThu=arChi.get(position);
